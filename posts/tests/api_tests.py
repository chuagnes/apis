...
class TestAPI(unittest.TestCase):
    ...
    def test_get_empty_posts(self):
        ...
        # request to endpt is successful
        self.assertEqual(response.status_code, 200)
        # endpt is returning JSON
    ...
    def test_delete_single_post(self):
        ...
        postB = models.Post(title="Example Post B", body="This post remains")
        session.add_all([postA, postB])
        session.commit()
        ...
        #data = json.loads(response.data.decode("ascii")) -- this returns 3 instead of 1 
        posts = session.query(models.Post).all()
        self.assertEqual(len(posts), 1)
        
        postB = posts[0]
        self.assertEqual(postB.title, "Example Post B")
        self.assertEqual(postB.body, "This post remains")
        #why doesn't self.assertEqual(postB["title"], "Example Post B") work?
    ...
    def test_get_posts_with_title_and_body(self):
        ...
        postA = models.Post(title="Post with bells", body="Just a test")
        postB = models.Post(title="Post with whistles", body="Still a test")
        postC = models.Post(title="Post with bells and whistles", body="bells")
